...
function pages($num, $curr_page, $perpage = 20, $urlrule = '', $array = array(),$setpages = 10) {
	...
	if($num > $perpage) {
		...
		$multipage .= '<ul class="pagination pagination-sm">';
		if($curr_page>0) {
			$multipage .= ' <li><a href="'.pageurl($urlrule, $curr_page-1, $array).'" >«</a><li>';
			if($curr_page==1) {
				$multipage .= ' <li><a class="on">1</a></li>';
		...
		for($i = $from; $i <= $to; $i++) {
			if($i != $curr_page) {
				...
				$multipage .= ' <li><a class="on" href="'.pageurl($urlrule, $i, $array).'">'.$i.'</a></li>';
			}
		}
		if($curr_page<$pages) {
			if($curr_page<$pages-5 && $more) {
				$multipage .= ' <li><a>..</a></li><li><a href="'.pageurl($urlrule, $pages, $array).'">'.$pages.'</a> </li><li><a href="'.pageurl($urlrule, $curr_page+1, $array).'">»</a></li>';
			} else {
				$multipage .= ' <li><a href="'.pageurl($urlrule, $pages, $array).'">'.$pages.'</a> </li><li><a href="'.pageurl($urlrule, $curr_page+1, $array).'" >»</a></li>';
			}
		} elseif($curr_page==$pages) {
			$multipage .= ' <li><a class="on">'.$pages.'</a></li><li> <a href="'.pageurl($urlrule, $curr_page, $array).'">»</a></li>';
		} else {
			$multipage .= ' <li><a href="'.pageurl($urlrule, $pages, $array).'">'.$pages.'</a></li><li> <a href="'.pageurl($urlrule, $curr_page+1, $array).'" >»</a></li>';
		}
		$multipage .= '</ul>';
